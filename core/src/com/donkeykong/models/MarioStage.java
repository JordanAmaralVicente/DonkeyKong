...
public class MarioStage implements Posicao, Imagem {
    ...
    public MarioStage(Stage stage, int posicaoX, int posicaoY, int width, int height) {
    ...
    public void atualizaImagem(boolean direcao) { //atualiza entre as duas imagens do mario. ainda faltam mais 2 para aimplementar
        ...
        MarioStage.status = !MarioStage.status;
    }
